...
import 'package:organic_shop/Pages/Other/product_info.dart';
...
class _AddReviewPageState extends State<AddReviewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     full: Image(image: AssetImage('graphics/background.png')),
     half: Image(image: AssetImage('graphics/background.png')),
     empty: Image(image: AssetImage('graphics/background.png')),
   ),
