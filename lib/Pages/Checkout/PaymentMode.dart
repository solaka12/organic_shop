    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          buildPaymentType(
              Image.asset('assets/PaymentIcons/payment_paypal.png'), 'PayPal'),
          buildPaymentType(Image.asset('assets/PaymentIcons/payment_payu.png'),
              'PayU Money'),
          buildPaymentType(
              Image.asset('assets/PaymentIcons/payment_stripe.png'), 'Stripe'),
          Spacer(),
        ],
      ),
    );
